        ...
        <div class="wrapper">
            <aside id="left-sidebar-nav">
                <ul id="slide-out" class="side-nav fixed leftside-navigation">
                    ...
                    <li class="bold"><a href="<?php echo base_url();?>admin/dataPenjualan" class="waves-effect waves-cyan"><i class="mdi-action-list"></i> Data Penjualan</a></li>
                    <li class="bold"><a href="<?php echo base_url();?>admin/dataPetugas" class="waves-effect waves-cyan"><i class="mdi-action-list"></i> Data Petugas</a></li>
                </ul>
